...
class Pending extends APP_GameClass
{
    ...
    function Roll2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            {
                game::$instance->addPending($this->player_id, "ConfirmPlace", $varg1 ,2);
            }
    ...
    function Roll3($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            if($this->player_pref_confirm == 2)
            {
                game::$instance->addPending($this->player_id, "ConfirmPlace", $varg1 ,3);
            }
    ...
    {   
        ...
        else
        {
            ...
            if($this->player_pref_confirm == 2)
            {
                game::$instance->addPending($this->player_id, "ConfirmPlace", $varg1 ,4);
            }
...
function argHappy2($parg1, $parg2) // RECUP TOKEN
    ...
    function Happy2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            if($this->player_pref_confirm == 2)
            {
                game::$instance->addPending($this->player_id, "ConfirmHappy", 2, $varg1);
            }
    ...
    function Happy5($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if($this->player_pref_confirm == 2)
        {
            game::$instance->addPending($this->player_id, "ConfirmHappy", 5, $varg1);
        }
    }
    ...
    function argHappy4($parg1, $parg2) // MOVE OPPONENT TOKEN
    {
        ...
        foreach($allBocksOnBoard as $bocknoselectable)
        {
            if(!in_array($bocknoselectable, $tab))
            {
    ...
    function Happy4Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            $explode = explode('_', $varg1);
            game::$instance->addPending($this->player_id, "ConfirmHappy", 4, $parg1.'_'.$parg2.'_'.$explode[1]);
        }
    ...
    function ConfirmPlace($parg1, $parg2, $varg1, $varg2)
    {
        if($varg1 == 'no')
        {
            ...
            {
                game::$instance->addPending($this->player_id, "Roll".$parg2);
            }
    ...
    //// CONFIRM STEPS HAPPY 2, 4, 5////////

    function argConfirmHappy($parg1, $parg2) // CONFIRM HAPPY
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret["noselectable"] = array();
    ...
    function ConfirmHappy($parg1, $parg2, $varg1, $varg2)
    {
        if($varg1 == 'no')
        {            
            game::$instance->addPending($this->player_id, "Happy".$parg1);
        }
        ...
        if($varg1 == 'yes')
        {
            ...
            if($parg1 == 4)
            {
                ...
                game::$instance->notifyAllPlayers(
                        ...
                        '',
                        array(
                            'enfant' => 'token_'.$explode[0].'_'.$explode[1],
                            'parent' => 'score'.$score.'_'.$explode[2],
                            'player_id' => $explode[1],
                            'bock' => $explode[2],
                ...
                game::$instance->notifyAllPlayers(
                        ...
                        array(
                            ...
                            'log1' =>    [
                            'log' => '${name1}',
                            'args' => ['name1' => game::$instance->_BOCK_A[$explode[0]]['name'], 'i18n' => ['name']]
                            ],
                            'log2' =>    [
                            'log' => '${name2}',
                            'args' => ['name2' => game::$instance->_BOCK_A[$explode[2]]['name'], 'i18n' => ['name']]
                            ],
                ...
                game::$instance->checkPinaHappy($explode[1]);
